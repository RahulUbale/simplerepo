...
Complete design for an AI ecosystem covering job search automation, financial
trading intelligence, an AI e-commerce product, and a personal AI assistant —
plus a 90-day execution plan and an operating manual.

**Start here:** [docs/README.md](docs/README.md) (includes the critical review
and build-priority decisions).

| Doc | System |
|---|---|
| [docs/01-job-search-platform.md](docs/01-job-search-platform.md) | JobOps — AI job search & application platform |
